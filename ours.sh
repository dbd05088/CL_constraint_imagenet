...
# CIL CONFIG
NOTE="ours_imagenet_memory_full_real_iter_0.0625" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours_v16"
...
if [ "$DATASET" == "cifar10" ]; then
    ...
    MEM_SIZE=1281167 ONLINE_ITER=0.046026749
...
do
    CUDA_VISIBLE_DEVICES=3 nohup python main.py --mode $MODE --n_worker 4 \
    ...
    --lr $LR --batchsize $BATCHSIZE --data_dir ~/jihun/data/imagenet --n_worker 4 \
