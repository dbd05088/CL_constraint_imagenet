...
# CIL CONFIG
NOTE="mir_imagenet_memory_full_iter0.0625" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="mir"
...
if [ "$DATASET" == "cifar10" ]; then
    ...
    MEM_SIZE=1281167 ONLINE_ITER=0.020270203
...
do
    ...
    --dataset $DATASET  --data_dir ~/jihun/data/imagenet --n_worker 4 \
