...
# CIL CONFIG
NOTE="der_imagenet_mem_full_iter0.25" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="der"
...
if [ "$DATASET" == "cifar10" ]; then
    ...
    MEM_SIZE=1281167 ONLINE_ITER=0.25
...
do
    CUDA_VISIBLE_DEVICES=7 nohup python main.py --mode $MODE --n_worker 8 \
    --dataset $DATASET --data_dir ~/jihun/data/imagenet \
