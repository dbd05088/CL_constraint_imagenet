...
# CIL CONFIG
NOTE="baseline_cifar10_class_count_sample_count_balancing_reverse_iter4" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="baseline"
...
do
    CUDA_VISIBLE_DEVICES=1 nohup python main.py --mode $MODE --loss_balancing_option $LOSS_BALANCING_OPTION \
